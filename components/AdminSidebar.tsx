...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-56 min-h-screen bg-slate-950 border-r border-slate-800 flex flex-col fixed top-0 left-0 z-40">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-slate-800">
        <Link href="/" className="flex items-center gap-2.5">
          <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center shrink-0">
            <svg viewBox="0 0 24 24" fill="none" className="w-4.5 h-4.5 text-white w-5 h-5" stroke="currentColor" strokeWidth="2.2">
